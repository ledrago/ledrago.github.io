...
let TodoDetailComponent = class TodoDetailComponent {
    constructor(dialog, route, store, router) {
        this.dialog = dialog;
        this.route = route;
        this.store = store;
        this.router = router;
...
let TodoEffects = class TodoEffects {
    constructor(actions$, todosService) {
        ...
        this.GetTodoList$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_todo_action__WEBPACK_IMPORTED_MODULE_5__["GetTodos"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(action => {
            return this.todosService.getTodos().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
        ...
        this.UpdateTodo$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_todo_action__WEBPACK_IMPORTED_MODULE_5__["UpdateTodo"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(action => {
            return this.todosService.updateTodo(action.payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
                return _todo_action__WEBPACK_IMPORTED_MODULE_5__["SuccessUpdateTodo"]();
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((error) => {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(_todo_action__WEBPACK_IMPORTED_MODULE_5__["ErrorTodo"](error));
            }));
        })));
        this.CreateTodo$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_todo_action__WEBPACK_IMPORTED_MODULE_5__["CreateTodo"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(action => {
            return this.todosService.createTodo(action.payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((data) => {
